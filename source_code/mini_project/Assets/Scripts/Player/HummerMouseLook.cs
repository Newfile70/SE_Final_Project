...
/// </summary>
public class HummerMouseLook : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        yRotation = Mathf.Clamp(yRotation, -20f, 26f);//Limit the size of the camera's up and down angles
        Gun.transform.localRotation = Quaternion.Euler(yRotation, 0f, 0f); //Set the camera up and down rotation
